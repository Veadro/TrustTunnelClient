...
/** Remove an element at offset */
#define ffarr_rm(ar, off)  _ffarr_rm((ffarr *)(ar), (off), 1, sizeof((ar)->ptr[0]))

/** Remove elements from the left. */
#define _ffarr_rmleft(ar, n, elsz)  _ffarr_rm(ar, 0, n, elsz)

/** Remove tail starting from offset */
#define ffarr_rmright(ar, off)  _ffarr_rm((ffarr *)(ar), (off), (ar)->len - (off), sizeof((ar)->ptr[0]))
...
#define FFSTR_INIT(s)  (ffstr){ FFSLEN(s), (char*)(s) }
#define FFSTR_INITZ(s)  (ffstr){ (s) ? ffsz_len(s) : 0, (char*)(s) }
#define FFSTR_INITN(s, l)  (ffstr){ (size_t)l, (char*)(s) }
...
enum FFSTR_NEXTVAL {
	...
	FFS_NV_WORDS = 0x1000, // ignore 'spl' char;  split by space or tab
};
...
FF_EXTN int fffile_writeall(const char *fn, const ffstr *data, uint flags);
