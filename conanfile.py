...
class VpnLibsConan(ConanFile):
    ...
    def requirements(self):
        self.requires("dns-libs/2.5.32@adguard_team/native_libs_common", transitive_headers=True)
        self.requires("native_libs_common/6.1.8@adguard_team/native_libs_common", force=True, transitive_headers=True)
